...
<body class="bg-slate-50 text-slate-800">
    ...
    <div class="container mx-auto p-4 sm:p-6 md:p-8 max-w-4xl">
        ...
        <header class="text-center mb-10">
            <div class="mb-6">
                <p class="text-lg font-semibold text-slate-700">Curso de Turismo da Universidade Estadual de Mato Grosso do Sul</p>
                <p class="text-sm text-slate-500">Elaborado pelo acadêmico Francisco José Moreira Filho</p>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 md:p-8">
                    ...
                    <div class="relative">
                        ...
                        <div class="timeline-item relative pl-10 pb-8">
                            ...
                            <p class="font-semibold text-slate-500">Dia Inteiro</p>
                            <h4 class="font-bold text-lg mt-1">Escolha sua Rota "Bate e Volta"</h4>
                            <p class="text-slate-600 mb-4">Selecione uma das opções abaixo para um dia de pilotagem e descobertas:</p>
                            
                            <div class="space-y-4">
                                <!-- Opção 1: Camisão/Aquidauana -->
                                ...
                                <!-- Opção 2: Rochedinho -->
                                <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                                    <h5 class="font-bold text-slate-800">Opção 2: Cultura e Natureza em Rochedinho</h5>
                                    <p class="text-sm text-slate-600 mt-1"><strong>Distância:</strong> ~40 km (ida) | <strong>Destaques:</strong> Passeio curto, cachoeiras e cultura quilombola.</p>
                                    <p class="text-sm text-slate-600 mt-2">Uma rota mais curta pela MS-080. Explore a região de Furnas do Dionísio, uma comunidade quilombola com cachoeiras e produção de doces e rapadura. Ideal para um passeio de meio dia com um almoço rural.</p>
                                </div>
                                 <!-- Opção 3: Bonito -->
                                <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                                    <h5 class="font-bold text-slate-800">Opção 3: Mergulho no Paraíso (Bonito)</h5>
                                    <p class="text-sm text-slate-600 mt-1"><strong>Distância:</strong> ~300 km (ida) | <strong>Destaques:</strong> Estrada longa e bem conservada, destino de ecoturismo mundial.</p>
                                    <p class="text-sm text-slate-600 mt-2">Para os mais dispostos. A viagem até Bonito pela BR-060 é longa, mas a recompensa é chegar a um dos destinos mais incríveis do Brasil. O ideal é sair muito cedo, fazer um passeio rápido como o Balneário Municipal e almoçar na cidade antes da longa volta. É um desafio de pilotagem e resistência.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Timeline Item -->
